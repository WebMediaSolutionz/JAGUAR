...
?>
<div class="<?php echo ( ( $i - 1 ) % 3 === 0 ) ? '' : 'separator '; ?>accessory object col-sm-6 col-md-4" data-filter="audio charging smart_watches">
	<div class="js-all-required-fields">
		...
		<div class="row">
			<div class="col-xs-6 col-sm-12 no_padding">
