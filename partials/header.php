...
<html class="<?php echo $page; ?>" lang="en" data-currentpage="<?php echo $page; ?>">
	...
	<body>
		...
		<div class="outer-container secondary_bg purple_bg<?php echo ( $page === 'devices' || $page === 'plans' || $page === 'accessories' || $page === 'cart_review' ) ? ' hidden-xs' : ''; ?><?php echo ( $page === 'plans2' ) ? ' hidden-xs' : ''; ?>">
