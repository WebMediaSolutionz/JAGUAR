<tr>
	...
	<td>
		<input class='frg-input-field js-required short' />
	</td>
	<td>
		<input class='frg-input-field js-required short' />
	</td>
	...
	<td class="js-calling-city">
		...
		<input class='frg-input-field js-required short js-cities-auto-complete' />
	...
	<td class="existing_phone_nbr hide">
		...
		<div class="status clearfix hide positive">
			<input value="1" class="frg-input-field js-phone_input_mask js-required short back-order left">
	...
	<td class="account_nbr hide">
		<div class="empty"></div>
		<input class='frg-input-field js-required short hide' />
	</td>
	<td>
		<div class="frg-select-container color-light left">
			<select class="js-required" autocomplete="off">
