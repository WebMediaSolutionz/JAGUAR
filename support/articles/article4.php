                ...
                <section class="article">
                    ...
                    <header class="article-header">
                        <div class="article-header__inner">
                            ...
                            <h1>How long will the cart save my order?</h1>
                        </div>
                    </header>
                    <!-- / End Article Header -->
                    ...
                    <div class="article-content article-content--troubleshooting">
                        <div class="article-content__inner">
                            ...
                            <p>
                                However, you must select each item in your order before proceeding. If you don’t, you will lose the items that have not been selected. 
                            </p>

                            <p>
                                To avoid unintended losses, you will receive a pop-up message reminding you that there are unselected items in order and confirming that you want to proceed to checkout.
                            </p>
                        </div>
                    </div>
