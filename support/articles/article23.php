    ...
    <section class="article">
                ...
                <div class="article-breadcrumb">
                    <nav class="article-breadcrumb__nav">
                        <ul>
                            ...
                            <li><a href="#" class="frg-link decoration-default">TELUS IQ Roles</a></li>
                        </ul>
                    </nav>
                </div>
        ...
        <div class="article-content article-content--troubleshooting">
            <div class="article-content__inner">
                ...
                <p>
                    First select your device from the Devices page<sup>1</sup>. On the Devices page, select the category you want to view or choose "All". A page of devices appears for your selection.
                </p>
                ...
                <p>
                    ...
                    Step 4 - Select the account number or BAN (Billing Account Number) that is to be linked to this order. Select your SIM card option. Apple device pages will have an Apple DEP Enrolment section. If you're interested in the Apple DEP Enrolment, select "dep20101 - $20/subscriber". If you don't want to enrol, click on "Do not enrol".
                </p>
                ...
                <p>
                    Next you will select a rate plan. Click "Save &amp; Continue".
                </p>
