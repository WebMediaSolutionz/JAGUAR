    ...
    <section class="article">
        ...
        <div class="article-content article-content--troubleshooting">
            <div class="article-content__inner">
                ...
                <p>
                    LOCATION: Manage -> Analytics -> Invoice Analytics
                </p>
                ...
                <p>
                    When your report is ready, you’ll recieve an email notification with instructions to log into the Analytics tab to download your report.
                </p>
            </div>
        </div>
