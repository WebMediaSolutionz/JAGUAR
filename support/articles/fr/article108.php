    ...
    <section class="article">
        ...
        <header class="article-header">
            <div class="article-header__inner">
                ...
                <h1>How do I see my available inventory?</h1>
            </div>
        </header>
        <!-- / End Article Header -->
        ...
        <div class="article-content article-content--troubleshooting">
            <div class="article-content__inner">
                <h3>How do I see my available inventory?</h3>
                ...
                <p>
                    Open the Assets page and click on Inventory. 
                </p>

                <img src="../../images/article108.png">
            </div>
        </div>
