    ...
    <section class="article">
        ...
        <header class="article-header">
            <div class="article-header__inner">
                ...
                <h1>How do I see the device for each employee?</h1>
            </div>
        </header>
        <!-- / End Article Header -->
        ...
        <div class="article-content article-content--troubleshooting">
            <div class="article-content__inner">
                <h3>How do I see the device for each employee?</h3>

                <p>
                    LOCATION: Manage > Assets > Assigned 
                </p>

                <p>
                    Step 1 - Click on Assets.<br />
                    Step 2 - In the left navigation click on Assigned.<br />
                    Step 3 - Review the Device Make/Model for each employee.<br />
                </p>

                <img src="../images/article109.png">
            </div>
        </div>
