                ...
                <section class="article">
                    ...
                    <header class="article-header">
                        <div class="article-header__inner">
                            ...
                            <h1>Upgrade Subscriber Devices</h1>
                        </div>
                    </header>
                    <!-- / End Article Header -->
                    ...
                    <div class="article-content article-content--troubleshooting">
                        <div class="article-content__inner">
                            ...
                            <p>
                                On the home page of the TELUS Enterprise Webstore, click on “Upgrade a Subscriber”.
                            </p>

                            <img src="../images/article18a.jpg">

                            <p>
                                Step 1 – Select the account number or BAN linked to the subscriber(s) you are upgrading. 
                            </p>
                            ...
                            <p>
                                Using the checkboxes next to the subscribers’ names, select the subscribers who you want to upgrade to the same device and features. 
                            </p>
                            ...
                            <p>
                                To upgrade another sub-group of subscribers with the same devices and features (that are different from the previous group), simply check the boxes next to their mobile numbers, and repeat the process above. 
                            </p>

                            <p>
                                When you have completed ordering the upgrades for all subscribers, click Continue. 
You’re taken to a shopping cart page that details your complete order. 
