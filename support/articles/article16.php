    ...
    <section class="article">
        ...
        <div class="article-content article-content--troubleshooting">
            <div class="article-content__inner">
                ...
                <p>
                    LOCATION:  Manage -> Services -> Subscriber checkbox -> Actions menu -> Change Status -> New Subscription Status = Active
                </p>

                <img src="../images/article16a.jpg">

                <p>
                    Leave the Effective Date blank for the change to take effect in near real time (approximately 60 seconds). Or, you can schedule the change to occur at a date in the future.
                </p>
            </div>
        </div>
