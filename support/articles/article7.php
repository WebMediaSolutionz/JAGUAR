                ...
                <section class="article">
                    ...
                    <div class="article-content article-content--troubleshooting">
                        <div class="article-content__inner">
                            ...
                            <p>What if the change is future-dated? Do you see green?</p>

                            <p>
                                Green flag – action is pending or in progress<br />
                                Black flag – the action is complete<br />
                                Red flag – the action failed to complete<br />
                            </p>

                            <p>
                                The indicator flags make it easier to see your progress particularly with large organizations that have hundreds of subscribers that require plan feature changes at the same time.  
                            </p>
                        </div>
                    </div>
