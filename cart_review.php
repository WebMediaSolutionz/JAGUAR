...
<div class="outer-container white_bg">
	<div class="inner-container clearfix">
		<div class="row">
			<div class="col-xs-12">
				...
				<table class="wide">
					<thead class="gray_text">
						<tr>
							<th>Select</th>
							<th>Item</th>
							<th class="hidden-xs hidden-sm">Quantity</th>
							<th class="hidden-xs hidden-sm">Description</th>
							<th class="hidden-xs hidden-sm">Availability</th>
							<th class="hidden-xs hidden-sm">Due monthly</th>
							<th>Due now</th>
						</tr>
					</thead>
					<tbody class="small gray_text">
						<tr class="wide">
							...
							<td class="description hidden-xs hidden-sm">
						...
						<tr class="wide">
							...
							<td class="vertical_align_top clearfix hidden-xs hidden-sm">
...
<div class="outer-container secondary_bg purple_bg">
	<div class="inner-container top_bottom_small_padding clearfix">
		<div class="row">
			<div class="col-xs-12">
				<a class="js-view_more" href="accessories.php">
